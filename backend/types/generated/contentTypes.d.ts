...
export interface ApiSessionFeedbackSessionFeedback
  extends Struct.CollectionTypeSchema {
...
export interface ApiSessionMediaSessionMedia
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::session-media.session-media'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    session: Schema.Attribute.Relation<'manyToOne', 'api::session.session'>;
...
export interface ApiSessionSession extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    liveYoutubeUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::session.session'
